...
root = Tk()  # สร้าง หน้าจอGUI
root.geometry('1000x625+400+40')  # กำหนดขนาดจอ
root.title('MONGKOL Counseling')
# กำหนดรูปภาพขึ้นมา
...
def on_click():
    ...
    root.after(1, on_click)  # เรียกเรื่อยๆ


root.after(1, on_click)  # มาพร้อมกัน
RPMprogressbar = IntVar()
showMAPvalue = StringVar()
showRPMvalue = StringVar()
showSPEEDvalue = StringVar()
showECTvalue = StringVar()  # ค่าที่setจากfunc
